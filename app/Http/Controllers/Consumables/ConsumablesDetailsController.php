...
class ConsumablesDetailsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('consumablesdetails/index');
    }
    ...
    public function create()
    {
        ...
        return view('consumablesdetails/edit')->with('category_type', 'consumable')
    ...
    public function store(ImageUploadRequest $request)
    {
        ...
        if ($consumable->save()) {
            return redirect()->route('consumablesdetails.index')->with('success', trans('admin/consumables/message.create.success'));
        }
    ...
    public function edit($consumableId = null)
    {
        if ($item = Consumable::find($consumableId)) {
            ...
            return view('consumablesdetails/edit', compact('item'))->with('category_type', 'consumable');
        }

        return redirect()->route('consumablesdetails.index')->with('error', trans('admin/consumables/message.does_not_exist'));
    }
