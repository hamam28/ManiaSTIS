        ...
        <div class="container" style="padding-top: 25px">
            <div class="row">
                <div class="container box">
                    <h3 class="text-center"> <img src="{{ url(asset('logo.png')) }}" style="width: 175px; height: 50px"></h3>
                    <h3 class="text-center" style="font-size: 20px"><strong>Badan Pusat Statistik</strong></h3>
                    <h1 class="text-center" style="font-size: 45px; margin-top: 5px"><strong>MANIA</strong></h1>
                    <h3 class="text-center" style="font-size: 23px; margin-top: 5px">Sistem Informasi Manajemen Inventarisasi Aset</h3>
                        ...
                        <div class="login-box-body">
                            ...
                            <div class="row ">
                                <div class="text-right col-md-12">
                                    <a href="{{ route('saml.login')  }}" style="font-size: 11pt;">{{ trans('auth/general.saml_login')  }}</a>
                                </div>
                            </div>
                            @endif
                        </div>
